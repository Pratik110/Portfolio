            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div className="flex-1">
                  ...
                  {edu.stream && (
                    <p className="text-xl text-slate-300 font-semibold mb-2" data-testid={`stream-${edu.id}`}>
                      {edu.stream}
                    </p>
                  )}
                ...
                <div className="mt-4 lg:mt-0 lg:text-right">
                  <div className="inline-flex items-center px-4 py-2 bg-slate-800 border border-slate-700 text-slate-200 rounded-full text-lg font-bold mb-2">
                    {getScoreIcon(edu.id)}
