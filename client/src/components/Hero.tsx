        ...
        <div className="animate-fade-in">
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-10 max-w-3xl mx-auto">
              <div className="neon-card rounded-2xl p-6 border-sky-900/40 bg-slate-900/80 text-left">
              ...
              <div className="neon-card rounded-2xl p-6 border-slate-700/70 bg-slate-900/80 text-left">
